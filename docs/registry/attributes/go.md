...
| --- | --- | --- | --- | --- |
| <a id="go-cpu-state" href="#go-cpu-state">`go.cpu.state`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The state of the CPU. | `user`; `gc-pause` |
...
| --- | --- | --- |
| `gc-mark-assist` | CPU time goroutines spent performing GC tasks to assist the GC. | ![Development](https://img.shields.io/badge/-development-blue) |
| `gc-mark-dedicated` | CPU time spent performing GC tasks on processors dedicated to those tasks. | ![Development](https://img.shields.io/badge/-development-blue) |
...
| `scavenge-assist` | CPU time spent returning unused memory to the underlying platform in response eagerly to memory pressure. | ![Development](https://img.shields.io/badge/-development-blue) |
| `scavenge-background` | CPU time spent performing background tasks to return unused memory to the underlying platform. | ![Development](https://img.shields.io/badge/-development-blue) |
