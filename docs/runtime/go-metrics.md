...
| [`go.memory.detailed_type`](/docs/registry/attributes/go.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | The detailed type of memory. | `mcache-inuse`; `heap-objects` |
...
| Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- |
| [`go.cpu.state`](/docs/registry/attributes/go.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The state of the CPU. | `user`; `gc-pause` |
...
| Value | Description | Stability |
| --- | --- | --- |
| `gc-mark-assist` | CPU time spent assisting the GC. | ![Development](https://img.shields.io/badge/-development-blue) |
| `gc-mark-dedicated` | CPU time spent on dedicated GC processors. | ![Development](https://img.shields.io/badge/-development-blue) |
| `gc-mark-idle` | CPU time spent performing GC tasks on spare CPU resources. | ![Development](https://img.shields.io/badge/-development-blue) |
| `gc-pause` | CPU time spent with the application paused by the GC. | ![Development](https://img.shields.io/badge/-development-blue) |
...
| `scavenge-assist` | CPU time spent returning unused memory to the underlying platform in response to memory pressure. | ![Development](https://img.shields.io/badge/-development-blue) |
| `scavenge-background` | CPU time spent returning unused memory to the underlying platform in the background. | ![Development](https://img.shields.io/badge/-development-blue) |
